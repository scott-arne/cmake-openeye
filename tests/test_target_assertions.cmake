...
if(TARGET OpenEye::OEAmber)
    assert_interface_link_libraries(OpenEye::OEAmber "OpenEye::OEChem;OpenEye::OEMolPotential")
endif()
if(TARGET OpenEye::OESmirnoff)
    assert_interface_link_libraries(OpenEye::OESmirnoff "OpenEye::OEChem;OpenEye::OEMolPotential;OpenEye::OEAmber")
endif()
if(TARGET OpenEye::OEAM1)
    assert_interface_link_libraries(OpenEye::OEAM1 "OpenEye::OEChem;OpenEye::OEMolPotential")
endif()
if(TARGET OpenEye::OEAM1BCC)
    assert_interface_link_libraries(OpenEye::OEAM1BCC "OpenEye::OEChem;OpenEye::OEAM1")
endif()
if(TARGET OpenEye::OEFF)
    assert_interface_link_libraries(OpenEye::OEFF "OpenEye::OEChem;OpenEye::OEMolPotential;OpenEye::OESmirnoff;OpenEye::OEAmber")
endif()
...
if(TARGET OpenEye::OEQuacpac)
    assert_interface_link_libraries(OpenEye::OEQuacpac "OpenEye::OEChem;OpenEye::OESzybki;OpenEye::OEAmber;OpenEye::OEAM1BCC")
endif()
if(TARGET OpenEye::OEOmega2)
    assert_interface_link_libraries(OpenEye::OEOmega2 "OpenEye::OEChem;OpenEye::OEMMFF;OpenEye::OESmirnoff")
endif()
